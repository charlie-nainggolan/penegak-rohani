...
<html lang="en">
  <head>
    ...
    <title>Penegak Rohani &middot; Nias</title>
  </head>
  <body>
          ...
          <ul class="nav nav-pills justify-content-center">
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a class="active dropdown-item" href="<?php echo base_url();?>bahasa/nias">Nias</a></li>
    ...
    <div class="container my-3">
        <h3 class="text-center">Daftar Lirik : Nias </h3>
          <div class="row">
